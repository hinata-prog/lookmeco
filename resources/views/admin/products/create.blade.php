                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="measurement_value" id="measurement_value" class="form-control" placeholder="Measurement Value">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        <input type="number" min="0" name="qty" id="qty" class="form-control" placeholder="Qty" disabled>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if (response["status"] == true) {
                    ...
                    handleFieldError('title', errors);
                    handleFieldError('slug', errors);
                    handleFieldError('short_description', errors);
                    handleFieldError('description', errors);
                    handleFieldError('shipping_returns', errors);
                    handleFieldError('category_id', errors);
                    handleFieldError('sub_category_id', errors);
                    handleFieldError('brand_id', errors);
                    handleFieldError('status',errors);
                    handleFieldError('is_featured', errors);
                    handleFieldError('track_qty', errors);
                    handleFieldError('qty', errors);
                    handleFieldError('barcode', errors);
                    handleFieldError('sku',errors);
                    handleFieldError('price',errors);
                    handleFieldError('compare_price',errors);
