                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description" id="short_description" cols="30" rows="5" class="summernote" placeholder="Short Description">{{ $product->short_description }}</textarea>
                                        <p></p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="shipping_returns" id="shipping_returns" cols="30" rows="7" class="summernote" placeholder="Shipping Returns">{{ $product->shipping_returns }}</textarea>
                                        <p></p>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="measurement_unit" id="measurement_unit" class="form-control">
                                            <option {{ ($product->measurement_unit == "gm") ? 'selected' : '' }} value="gm">Gram</option>
                                            <option {{ ($product->measurement_unit == "oz") ? 'selected' : '' }} value="oz">Ounce</option>
                                            <option {{ ($product->measurement_unit == "lb") ? 'selected' : '' }} value="lb">Pounds</option>
                                            <option {{ ($product->measurement_unit == "kg") ? 'selected' : '' }} value="kg">Kilogram</option>
                                            <option {{ ($product->measurement_unit == "floz") ? 'selected' : '' }} value="floz">Fluid Ounce</option>
                                            <option {{ ($product->measurement_unit == "ml") ? 'selected' : '' }} value="ml">Milliliters</option>
                                            <option {{ ($product->measurement_unit == "l") ? 'selected' : '' }} value="l">Liters</option>
                                            <option {{ ($product->measurement_unit == "gal") ? 'selected' : '' }} value="gal">Gallon</option>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="measurement_value" id="measurement_value" class="form-control" placeholder="Measurement Value"  value="{{ $product->measurement_value }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
