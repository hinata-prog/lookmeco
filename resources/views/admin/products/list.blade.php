                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex">
                                    @if (!empty($product->images) && count($product->images) > 0)
                                            <img src="{{ asset('uploads/products/small/' . $product->images->last()->image) }}" class="img-thumbnail mr-2" width="50">
                                    @else
                            ...
                            <td>{{ $product->measurement_value }} {{ $product->measurement_unit }}</td>
