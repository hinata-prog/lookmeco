    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="sub-categories.index" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $subCategory->slug }}" type="text" readonly name="slug" id="slug" class="form-control" placeholder="Slug">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="showHome">Show in Home</label>
